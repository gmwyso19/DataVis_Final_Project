...
content <- Water_coord2$County
leaflet(data = Water_coord2)  %>%
setView(lng = -119.4179, lat = 36.7783, zoom = 4.5) %>% addTiles() %>% addProviderTiles(providers$Wikimedia) %>% addCircleMarkers(lng = Water_coord2$Longitude,
